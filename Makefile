...
CXX = $(MFEM_CXX)
MEQ_FLAGS = -O3 -std=c++17 -Wall -I$(TOML11_DIR) -I$(SUNDIALS_DIR)/include -I/usr/include/suitesparse
...
meq: meq.cpp FreeBoundary.cpp $(GSINVERTER_DEP) $(MFEM_LIB_FILE)
	$(CXX) $(MFEM_FLAGS) $(MEQ_FLAGS) -o $@ meq.cpp FreeBoundary.cpp $(GSINVERTER_SRC) $(MFEM_LIBS)

mfemGS: mfemGS.cpp SolovievEquilibrium.hpp $(HEADER_DEP) $(GSINVERTER_DEP) $(MFEM_LIB_FILE)
	$(CXX) $(MFEM_FLAGS) $(MEQ_FLAGS) -o $@ mfemGS.cpp $(GSINVERTER_SRC) $(MFEM_LIBS)

mfemLinearConvergence: mfemLinearConvergence.cpp SolovievEquilibrium.hpp $(HEADER_DEP) $(GSINVERTER_DEP) $(MFEM_LIB_FILE)
	$(CXX) $(MFEM_FLAGS) $(MEQ_FLAGS) -o $@ mfemLinearConvergence.cpp $(GSINVERTER_SRC) $(MFEM_LIBS)

meshgenpp: meshgenpp.cpp meshgen.cpp $(HEADER_DEP) $(MFEM_LIB_FILE)
	$(CXX) $(MFEM_FLAGS) $(MEQ_FLAGS) -o $@ meshgenpp.cpp meshgen.cpp -lgmsh $(MFEM_LIBS)

mfemProjector: mfemProjector.cpp $(HEADER_DEP) $(MFEM_LIB_FILE)
	$(CXX) $(MFEM_FLAGS) $(MEQ_FLAGS) -o $@ mfemProjector.cpp  $(MFEM_LIBS) -lnetcdf_c++4 -lnetcdf

mfemCheck: mfemCheck.cpp $(HEADER_DEP) $(MFEM_LIB_FILE)
	$(CXX) $(MFEM_FLAGS) $(MEQ_FLAGS) -o $@ mfemCheck.cpp $(MFEM_LIBS)

FluxSurfaces: FluxSurfaces.cpp $(HEADER_DEP) $(MFEM_LIB_FILE)
	$(CXX) $(MFEM_FLAGS) $(MEQ_FLAGS) -o $@ FluxSurfaces.cpp $(MFEM_LIBS) -lnetcdf_c++4 -lnetcdf

vacuum-test: VacuumGFSoln.cpp FreeBoundary.cpp $(HEADER_DEP)
	$(CXX) $(MFEM_FLAGS) $(MEQ_FLAGS) -o $@ VacuumGFSoln.cpp FreeBoundary.cpp $(MFEM_LIBS) -lnetcdf_c++4 -lnetcdf

vacuum-mesh-test: VacuumMeshSoln.cpp FreeBoundary.cpp $(HEADER_DEP)
	$(CXX) $(MFEM_FLAGS) $(MEQ_FLAGS) -o $@ VacuumGFSoln.cpp FreeBoundary.cpp $(MFEM_LIBS)

clean:
	rm -f meshgenpp mfemGS mfemGS-debug meq meq-debug mfemCheck mfemProjector vacuum-test vacuum-mesh-test FluxSurfaces
