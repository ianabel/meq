...
CXX = g++
CXXFLAGS_RELEASE = -std=c++14 -O3 -Wall -mtune=native
CXXFLAGS_DEBUG = -std=c++14 -g -Og -Wall
...
mfemHDGPoisson: mfemHDGPoisson.cpp $(GSINVERTER_DEP) FreeBoundary.hpp 
	$(CXX) $(CXXFLAGS_DEBUG) mfemHDGPoisson.cpp $(GSINVERTER_SRC) -o mfemHDGPoisson $(MFEM_DEBUG_LIB) $(SUNDIALS_LIB) -I$(MFEM_DIR) -L$(MFEM_DIR)

mfemHDGPoissonNL: mfemHDGPoissonNL.cpp $(GSINVERTER_DEP)
	$(CXX) $(CXXFLAGS_RELEASE) mfemHDGPoissonNL.cpp $(GSINVERTER_SRC) -o mfemHDGPoissonNL $(MFEM_LIB) $(SUNDIALS_LIB) -I$(MFEM_DIR) -L$(MFEM_DIR)

mfemHDGPoissonNL-KINSOL: mfemHDGPoissonNL-KINSOL.cpp $(GSINVERTER_DEP)
	$(CXX) $(CXXFLAGS_RELEASE) mfemHDGPoissonNL-KINSOL.cpp $(GSINVERTER_SRC) -o mfemHDGPoissonNL-KINSOL $(MFEM_LIB) $(SUNDIALS_LIB) -I$(MFEM_DIR) -L$(MFEM_DIR)

mfemHDGPoissonNL-KINSOL-DEBUG: mfemHDGPoissonNL-KINSOL.cpp $(GSINVERTER_DEP)
	$(CXX) $(CXXFLAGS_DEBUG) mfemHDGPoissonNL-KINSOL.cpp $(GSINVERTER_SRC) -o mfemHDGPoissonNL-KINSOL-DEBUG $(MFEM_DEBUG_LIB) $(SUNDIALS_LIB) -I$(MFEM_DIR) -L$(MFEM_DIR)
...
mfem-test: mfem-test.cpp $(GSINVERTER_DEP)
	$(CXX) $(CXXFLAGS_DEBUG) mfem-test.cpp HDGGSIntegrator.cpp -o mfem-test $(MFEM_DEBUG_LIB) $(SUNDIALS_LIB) -I$(MFEM_DIR) -L$(MFEM_DIR)

mfemSurfaceTracer: mfemSurfaceTracer.cpp
	$(CXX) $(CXXFLAGS_DEBUG) mfemSurfaceTracer.cpp -o mfemSurfaceTracer $(MFEM_DEBUG_LIB) $(SUNDIALS_LIB) -I$(MFEM_DIR) -L$(MFEM_DIR)

Baxis: Baxis.cpp
	$(CXX) $(CXXFLAGS_DEBUG) Baxis.cpp -o Baxis $(MFEM_DEBUG_LIB) $(SUNDIALS_LIB) -I$(MFEM_DIR) -L$(MFEM_DIR)
