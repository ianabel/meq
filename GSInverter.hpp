...
namespace meq {
	...
	class GSInverter : public mfem::Operator
	{
		...
		public:
			...
			FiniteElementSpace *QSpace() const { return SolutionSpace->QSpace(); };
			FiniteElementSpace *USpace() const { return SolutionSpace->USpace(); };
			FiniteElementSpace *MSpace() const { return SolutionSpace->MSpace(); };

			FiniteElementSpace *UStarSpace() const { return SolutionSpace->UStarSpace(); };
