...
#: Where the built binary lives.  `README.md` has the build commands.
CHEASE = os.environ.get("CHEASE_EXE",
                        "/home/ian/projects/chease/src-f90/chease")
...
def units(meta):
	...
	MXH's `R0` parameter, which differs from it once there is any shaping.  It
	has to be the geometric one because `NRSCAL = 0` normalises the boundary so
